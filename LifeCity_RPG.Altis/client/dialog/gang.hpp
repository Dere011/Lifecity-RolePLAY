...
class Life_Browse_Gang_Diag {
	...
	class controls {
		...
		class Title : Life_RscTitle {
			colorBackground[] = {0, 0, 0, 0};
			idc = -1;
			text = "Contrôle de Groupe - Groupe présent";
			x = 0.1;
			y = 0.2;
			w = 0.6;
			h = (1 / 25);
...
class Life_Create_Gang_Diag {
	...
	class controls {
		...
		class InfoMsg : Life_RscStructuredText
		{
			idc = -1;
			sizeEx = 0.020;
			text = "<t align='center'>La creation de gang est gratuite!</t>";
			x = 0.1;
			y = 0.25;
			w = 0.5; h = 0.32;
		};
...
class Life_Gang_Prompt
{
	...
	class controls 
	{
		class InfoMsg : Life_RscStructuredText
		{
			idc = -1;
			sizeEx = 0.020;
			text = "<t align='center'><t size='.8px'>Vous êtes présentement dans aucun groupe, que voulez-vous faire?</t></t>";
			x = 0.287;
			y = 0.2 + (11 / 250);
			w = 0.5; h = 0.12;
		};
