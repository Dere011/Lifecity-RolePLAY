...
if(srwapffq < life_bail_amount) exitWith {hint format["You do not have $%1 in your bank account to pay bail.",life_bail_amount];};

srwapffq = srwapffq - life_bail_amount;
life_bail_paid = true;
