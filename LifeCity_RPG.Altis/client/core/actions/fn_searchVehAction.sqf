...
if((cursorTarget getVariable["blackmesa", false])) exitWith {
	hint parseText "<t color='#FF0000'><t size='2'>Vehicle Info</t></t><br/><t color='#FFD700'><t size='1.5'>Owners</t></t><br/> GM... ????";
};

if((_vehicle isKindOf "Car") || !(_vehicle isKindOf "Air") || !(_vehicle isKindOf "Ship")) then
{
	_owners = _vehicle getVariable "vehicle_info_owners";
	if(isNil {_owners}) exitWith {hint "This vehicle has no information, it was probably spawned in through cheats or for admin event. \n\nDeleting vehicle.";};
