...
switch (true) do
{
	case (player distance (getMarkerPos "lead_1") < 30): {_mine = "copperore"; _val = 4;};
	case (player distance (getMarkerPos "iron_1") < 30): {_mine = "ironore"; _val = 4;};
	case (player distance (getMarkerPos "iron_1_1") < 30): {_mine = "ironore"; _val = 4;};
	...
	case (player distance (getMarkerPos "rock_1") < 50): {_mine = "rock"; _val = 4;};
	default {_mine = "";};
};
//Mine check
