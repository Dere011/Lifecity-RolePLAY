...
*/
private["_ui","_food","_water","_health","_insurance"];
...
_insurance = _ui displayCtrl 23520;
...
//Update Assurance
_insurance ctrlSetPosition [safeZoneX+safeZoneW-0.090,safeZoneY+safeZoneH-0.40];
if(lc_has_lifeinsurance) then {
	_insurance ctrlSetText "ON";
}else{
	_insurance ctrlSetText "OFF";
};
_insurance ctrlCommit 0;
