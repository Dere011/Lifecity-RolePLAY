...
if (BTC_def_hud == 1) then 
{
	...
	BTC_arrow_up   = "addons\logistic\=BTC=_Lift\img\arrow_up_ca.paa";
	BTC_arrow_down = "addons\logistic\=BTC=_Lift\img\arrow_down_ca.paa";
	BTC_complete   = "addons\logistic\=BTC=_Lift\img\objective_complete_ca.paa";
	BTC_incomplete = "addons\logistic\=BTC=_Lift\img\objective_incomplete_ca.paa";
};
BTC_cargo      = ObjNull;
//Functions
BTC_lift_check =
