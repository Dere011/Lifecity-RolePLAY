...
if !(isServer && isDedicated) then
{
	...
	R3F_LOG_action_heliporter_valide = true;
	R3F_LOG_action_heliport_larguer_valide = true;
	
	R3F_LOG_action_deplacer_objet_valide = true;
	R3F_LOG_action_remorquer_deplace_valide = true;
	R3F_LOG_action_selectionner_objet_remorque_valide = true;
	R3F_LOG_action_detacher_valide = true;
	R3F_LOG_action_charger_deplace_valide = true;
