...
[[[_sp,_type],{srwapffq = srwapffq + (_this select 0); hint format["Vous avez vendu votre vehicule pour $%1",[(_this select 0)] call life_fnc_numberText];}], "BIS_fnc_call", _unit, false] spawn life_fnc_MP;
