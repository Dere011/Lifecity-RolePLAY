private["_uid","_name","_side","_money","_bank","_licenses","_gear","_array","_unit","_dbName","_check","_time","_arrested","_assurance"];
...
switch (_side) do {
	...
	case civilian:
	{
		...
		[_dbName, _uid, "arrested", _arrested] call iniDB_write;
	};
};
